...
# //  Description   : It accepts two directory names from user and copy all files from 
#                     first directory to second directory 
# //  Input         : String, String
# //  Ouput         : Nothing
...
def main():
    ...
    if(len(sys.argv) != 3):
        ...
        schedule.every(10).seconds.do(DirCpy,sys.argv[1],sys.argv[2])
